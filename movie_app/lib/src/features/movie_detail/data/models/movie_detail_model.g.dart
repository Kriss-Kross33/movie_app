...
MovieDetailModel _$MovieDetailModelFromJson(Map<String, dynamic> json) =>
    MovieDetailModel(
      ...
      genres: (json['genres'] as List<dynamic>?)
          ?.map((e) => MovieGenres.fromJson(e as Map<String, dynamic>))
          .toList(),
...
MovieGenres _$MovieGenresFromJson(Map<String, dynamic> json) => MovieGenres(
      id: json['id'] as int?,
      name: json['name'] as String?,
    );

Map<String, dynamic> _$MovieGenresToJson(MovieGenres instance) =>
    <String, dynamic>{
      'id': instance.id,
      'name': instance.name,
    };
