...
import 'get_trending_test.mocks.dart';
...
void main() {
  ...
  setUp(() {
    ...
    getTrending = GetTrending(mockMovieRepository);
  });

  test('should get List of trending movies from the repository', () async {
    ...
    //* arrange
    when(mockMovieRepository.getTrending())
